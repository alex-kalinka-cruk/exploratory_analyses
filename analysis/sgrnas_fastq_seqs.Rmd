...
plot_sgrna_hist(kusa.v3.counts, "Kusa v3 Original Library")
...
plasmid.1 <- read.table(file.path(base_path.ht29,"crisprn","plasmid_test","counts","Plasmid_AZ_1.s_1.counts"),
                        stringsAsFactors = F) %>%
  left_join(kusa.v3, by = c("V1" = "CODE"))

ggplot(plasmid.1, aes(GC_percent, V3, group = GC_percent)) +
  geom_point() +
  geom_boxplot() +
  geom_smooth() +
  ylim(0,2000)
