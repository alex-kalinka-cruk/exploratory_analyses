...
```{r}
kable(summarise.sgrna_counts(yusa.v3,"Yusa_v3"))

```

# Orphan sgRNAs

Defined as sgRNAs that don't have gene IDs in the `GENES` column of the original Yusa v3 file and are missing in the Plasmid count files (entered as '.'), but have valid gene IDs in their sgRNA IDs. Several genes in here have all 6 of their sgRNAs present (see sgRNA counts below).
